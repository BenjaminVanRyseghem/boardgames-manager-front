		...
		return (
			<Modal className="lend-to-modal" isOpen={this.state.open} toggle={toggle}>
				<ModalHeader toggle={toggle}>
					<Translate i18nKey="deleteGame" name={this.props.game.name}>Delete $name$</Translate>
				</ModalHeader>
				<ModalBody>
					<Interpolate i18nKey="deleteGameText" name={this.props.game.name}>
				...
				<ModalFooter>
					<Button color="danger" onClick={() => {
						...
						<Translate i18nKey="delete">Delete</Translate>
					</Button>{" "}
